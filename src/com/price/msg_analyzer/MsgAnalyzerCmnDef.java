...
// Functions	
	...
	public static void WriteDebugSyslog(String msg){msg_dumper.write_debug_msg(msg);}
	public static void WriteInfoSyslog(String msg){msg_dumper.write_info_msg(msg);}
	public static void WriteWarnSyslog(String msg){msg_dumper.write_warn_msg(msg);}
	public static void WriteErrorSyslog(String msg){msg_dumper.write_error_msg(msg);}
...
//					WriteDebugFormatSyslog("Date: %s, Time: %s, Number: %d, Severity: %s", date, time, number, severity);
	// Copy the content
...
//					WriteDebugFormatSyslog("Content: %s", content);
		...
		if (CheckSuccess(ret))
		{
			String res = String.format("Date: %s, Time: %s, Number: %d, Severity: %s, Content: %s", date, time, number, severity, content);
